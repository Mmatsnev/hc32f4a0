...
#if (DDL_DVP_ENABLE == DDL_OFF)
#error "please configure macro definition DDL_DVP_ENABLE to DDL_ON in ddl_config.h"
#endif
...
#endif /* BSP_EV_HC32F4A0_LQFP176/BSP_OV5640_ENABLE */
