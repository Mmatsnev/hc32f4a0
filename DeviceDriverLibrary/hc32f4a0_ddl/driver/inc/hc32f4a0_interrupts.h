...
void EFM_0_PgmEraseErr_IrqHandler(void);
void EFM_0_ColErr_IrqHandler(void);
void EFM_0_OpEnd_IrqHandler(void);
void EFM_1_PgmEraseErr_IrqHandler(void);
void EFM_1_ColErr_IrqHandler(void);
void EFM_1_OpEnd_IrqHandler(void);
