...
/**
 * @addtogroup TMR4_PWM_Dead_Timer_Mode
 * @{
 */
...
#define TMR4_CNT_CYCLE_VAL(div)         ((uint16_t)(Tmr4PclkFreq() / (1UL << (uint32_t)(div)) / 32UL)) /* Period_Value(31.25ms) */
...
int32_t main(void)
{
    ...
    stcTmr4CntInit.u16PclkDiv = TMR4_CNT_PCLK_DIV128;
